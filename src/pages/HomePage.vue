    ...
    <!-- <div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <g mask="url(&quot;#SvgjsMask1020&quot;)" fill="none">
                    <path
                        d="M 0,57 C 41.2,86.2 123.6,203 206,203 C 288.4,203 329.6,60.2 412,57 C 494.4,53.8 535.6,182 618,187 C 700.4,192 741.6,74.8 824,82 C 906.4,89.2 947.6,228.8 1030,223 C 1112.4,217.2 1154,47.6 1236,53 C 1318,58.4 1399.2,210.6 1440,250L1440 560L0 560z"
                        fill="rgba(245, 187, 0, 1)"></path>
                    <path
                        d="M 0,369 C 48,403.4 144,544.2 240,541 C 336,537.8 384,359 480,353 C 576,347 624,508.4 720,511 C 816,513.6 864,361.6 960,366 C 1056,370.4 1104,538.2 1200,533 C 1296,527.8 1392,378.6 1440,340L1440 560L0 560z"
    ...
    <div class="svg-home">
      ...
      <div class="logo d-flex justify-content-center mt-5">
        <svg
          ...
          data-name="Livello 1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="-78 0 938.48 320.88"
        >
          <defs></defs>
          <title>DELEVBOO-def</title>
          <line class="cls-1" x1="495.66" y1="135.03" x2="410.72" y2="135.03" />
          <line class="cls-1" x1="493.01" y1="117.63" x2="322.95" y2="117.63" />
          <path
            class="cls-2"
